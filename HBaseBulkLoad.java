...
HPut.add(Bytes.toBytes("details"), Bytes.toBytes("name"), Bytes.toBytes(parts[1]));
HPut.add(Bytes.toBytes("details"), Bytes.toBytes("location"), Bytes.toBytes(parts[2]));
HPut.add(Bytes.toBytes("details"), Bytes.toBytes("age"), Bytes.toBytes(parts[3]));
